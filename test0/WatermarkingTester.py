...
workplace = "/Digital-Video-Watermarker-master"
...
def get_arguments():
    ...
    parser.add_argument('--watermark_algorithm',  default='WhitePixelRandomFrames' , help='Algorithm to use for watermarking')
    parser.add_argument('--watermark_algorithm_aggressiveness', type=int, default= 30,  help='Algorithms agressiveness between 0 - 100')
    parser.add_argument('--distortion_algorithms',  default='BlackAndWhite',help='Distortion Algorithms separated with comma')
    parser.add_argument('--comparison_output', default='comparison.mp4', help='Full path of output video')
